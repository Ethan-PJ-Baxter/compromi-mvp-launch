            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-primary/80 to-primary/40 border-2 border-background flex items-center justify-center text-xs font-bold text-primary-foreground"
                  >
            ...
            <div className="relative">
              ...
              <div className="relative phone-mockup bg-card rounded-[2.5rem] p-2 border border-border/50 animate-float">
                <div className="relative overflow-hidden rounded-[2rem] bg-background">
                  ...
                  <img
                    src={appScreenshot}
                    alt="Compromi App - Track your fitness wagers"
